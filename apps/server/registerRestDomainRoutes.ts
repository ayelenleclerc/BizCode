...
import { registerFiscalRoutes } from './routes/registerFiscalRoutes'
import { registerPaymentRoutes } from './routes/registerPaymentRoutes'
...
import { registerVisitasRoutes } from './routes/registerVisitasRoutes'
...
import { registerSugerenciasPedidoRoutes } from './routes/registerSugerenciasPedidoRoutes'
...
import { registerTwilioWhatsAppWebhookRoutes } from './routes/registerTwilioWhatsAppWebhookRoutes'
...
import { registerFarmaciaRoutes } from './routes/registerFarmaciaRoutes'
import { registerExportacionRoutes } from './routes/registerExportacionRoutes'
...
export function registerRestDomainRoutes(app: Application, prisma: PrismaClient): void {
  ...
  registerTwilioWhatsAppWebhookRoutes(app, ctx)
  ...
  registerFiscalRoutes(app, ctx)
  registerPaymentRoutes(app, ctx)
  registerPedidosRoutes(app, ctx)
  registerVoiceRoutes(app)
  registerVisitasRoutes(app, ctx)
  registerFeriadosRoutes(app, ctx)
  registerVendedorZonasRoutes(app, ctx)
  registerRutasRoutes(app, ctx)
  ...
  registerFarmaciaRoutes(app, ctx)
  registerExportacionRoutes(app, ctx)
