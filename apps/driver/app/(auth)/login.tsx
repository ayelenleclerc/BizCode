      ...
      <View style={styles.card}>
        ...
        <TextInput
          ...
          {...({
            ...
            testID: 'driver-login-password',
            accessibilityLabel: t('login.password'),
          } as object)}
        />

        {displayError ? (
          <View testID="driver-login-error" accessibilityLiveRegion="polite">
