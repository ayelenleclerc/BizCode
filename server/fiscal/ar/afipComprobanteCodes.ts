...
const AFIP_TIPO_TO_LETTER: Readonly<Record<number, 'A' | 'B' | 'C'>> = {
  1: 'A',
  6: 'B',
  11: 'C',
}
 ...
 */
export function afipTipoComprobanteToLetter(tipoCmp: number): 'A' | 'B' | 'C' | null {
  return AFIP_TIPO_TO_LETTER[tipoCmp] ?? null
}
