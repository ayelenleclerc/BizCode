...
| DGI (Uruguay) | `uruguay_dgi` | `true` (mock CFE de homologación; live no evidenciado) | `apps/server/fiscal/uy/UruguayDgiFiscalAdapter.ts` → `UruguayDgiService` + `uyDgiCfeMock` ([ADR-0025](../adr/ADR-0025-uruguay-dgi-cfe-mock.md)) |
