...
**Documentos incluidos:** este manual, [indice-paquete-iso.md](indice-paquete-iso.md) (ISO-PKG-001), [trazabilidad-iso.md](trazabilidad-iso.md), [plantillas-registros.md](plantillas-registros.md), [ciclo-vida-y-validacion-documental.md](ciclo-vida-y-validacion-documental.md) (SemVer, historial, validación); en `docs/*/quality/`: estrategia de pruebas, ciclo CI/CD, plan Swagger/OpenAPI; en `docs/*/`: estándares de código, accesibilidad, estrategia i18n, seguridad; y todos los ADR.
...
**Otros idiomas:** [English](../../en/certificacion-iso/quality-manual.md) · [Português](../../pt-br/certificacion-iso/manual-qualidade.md)
