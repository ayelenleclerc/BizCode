...
- **Negative:** Snyk gate is inactive until `SNYK_TOKEN` is configured; first Snyk runs may fail until HIGH/CRITICAL with fixes are remediated or base images bumped; Dependabot PRs need review bandwidth.
