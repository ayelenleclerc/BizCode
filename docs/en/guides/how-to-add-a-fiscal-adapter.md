...
| DGI (Uruguay) | `uruguay_dgi` | `true` (homologación mock CFE; live Not evidenced) | `apps/server/fiscal/uy/UruguayDgiFiscalAdapter.ts` → `UruguayDgiService` + `uyDgiCfeMock` ([ADR-0025](../adr/ADR-0025-uruguay-dgi-cfe-mock.md)) |
