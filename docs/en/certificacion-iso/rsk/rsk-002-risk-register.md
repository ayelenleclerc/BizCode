...
| R-05 | Backup restore failure or untested DR | M | H | Platform ops | A.8.13, A.5.30 | Scripts #150; drill/#197 pending |
...
| R-11 | Business continuity gap (no SLA / unproven RTO) | H | H | Product owner | A.5.29, A.5.30 | Tracked in [#197](https://github.com/ayelenleclerc/BizCode/issues/197) |
