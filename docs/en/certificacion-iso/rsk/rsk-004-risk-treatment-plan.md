...
| R-05 | Mitigate | Local restore smoke done (SEC-015); execute staging drill; record RTO | Platform ops | Staging host ready | [#197](https://github.com/ayelenleclerc/BizCode/issues/197) |
...
| R-11 | Mitigate | SLA/DR docs published; activate status page; complete staging drill | Product owner | Remaining #197 AC | [#197](https://github.com/ayelenleclerc/BizCode/issues/197) |
