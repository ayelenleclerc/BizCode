...
| BP1-1 | P1 | Order (`pedido`) domain | **Done (#132+#223+#391):** commercial MVP + module gating + full lifecycle `packed`…`collected` with remito/OE/cobro wiring (`PedidoService`, `/api/pedidos/{id}/pack|ship|deliver|collect`, ADR-0009) |
