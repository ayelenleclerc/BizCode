...
| `apps/seller/` | Expo (React Native) App Seller — field sales (#167) |
...
**Note:** `@bizcode/ui` (#157) is out of scope for #167; do not block type-check or login on that package.
