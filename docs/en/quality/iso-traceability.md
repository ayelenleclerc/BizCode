...
This matrix maps BizCode's quality artefacts to clauses of the applicable ISO standards. **Controlled Markdown** exists in **three languages** under `docs/en/`, `docs/es/`, and `docs/pt-br/` with **localized filenames** per tree (see [I18N_DOCUMENTATION.md](../../I18N_DOCUMENTATION.md) and [DOCUMENT_LOCALE_MAP.md](../../DOCUMENT_LOCALE_MAP.md)).
...
- ISO 29119: Parts 2 and 4 are covered by the testing strategy; Part 3 (test documentation) is supported at MVP level by `docs/*/specs/manual-test-cases.md` and session records using `records-template.md`.
