...
**Evidência:** issues GitHub #227 (catálogo), #223 (motor por tenant), #224 (frontend), #226 (pricing/trials), #181 (planos SaaS) · marcos v0.11.5 / v0.11.0
...
|-------|-------------------|----------------------------|
| `logistics.dispatches` | Repartos + relatórios | `ModuleRoute` em `/logistica`, `/logistica/repartos`, `/logistica/repartos/chofer`; aba **Relatórios** em `/logistica` (#145, sem chave nova); `requireModule('logistics.dispatches')` em `GET /api/logistica/*` ([`registerLogisticaReportesRoutes.ts`](../../../server/routes/registerLogisticaReportesRoutes.ts)); nav em [`navSections.ts`](../../../src/components/layout/navSections.ts); rotas `/api/repartos` (RBAC) |
