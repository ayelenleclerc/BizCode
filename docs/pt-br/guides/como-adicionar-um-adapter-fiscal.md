...
| DGI (Uruguai) | `uruguay_dgi` | `true` (mock CFE de homologação; live não evidenciado) | `apps/server/fiscal/uy/UruguayDgiFiscalAdapter.ts` → `UruguayDgiService` + `uyDgiCfeMock` ([ADR-0025](../adr/ADR-0025-uruguay-dgi-cfe-mock.md)) |
