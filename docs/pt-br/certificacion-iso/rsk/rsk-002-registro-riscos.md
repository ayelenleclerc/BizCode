...
| R-05 | Falha de restore / DR não testado | M | H | Ops plataforma | A.8.13, A.5.30 | Scripts #150; **smoke local** SEC-015 (2026-08-25); drill staging pendente [#197](https://github.com/ayelenleclerc/BizCode/issues/197) |
...
| R-11 | Lacuna de continuidade (sem SLA / RTO não provado) | H | H | Product owner | A.5.29, A.5.30 | Docs SLA/DR (#197); **uptime público + RTO staging** ainda abertos |
