...
- **Negativo:** O gate Snyk fica inativo até configurar `SNYK_TOKEN`; as primeiras execuções do Snyk podem falhar até remediar HIGH/CRITICAL com fix ou atualizar imagens base.
