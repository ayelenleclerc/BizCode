...
GLOBAL_REPL = [
    ...
    ("../../en/quality/iso-traceability.md", "../../en/certificacion-iso/iso-traceability.md"),
    ("../../en/quality/TESTING_STRATEGY.md", "../../en/quality/testing-strategy.md"),
    ("../../en/quality/CI_CD.md", "../../en/quality/ci-cd.md"),
    ("../../en/quality/quality-manual.md", "../../en/certificacion-iso/quality-manual.md"),
    ("../../en/quality/records-template.md", "../../en/certificacion-iso/records-template.md"),
    ...
    ("../../es/quality/trazabilidad-iso.md", "../../es/certificacion-iso/trazabilidad-iso.md"),
    ("../../es/quality/TESTING_STRATEGY.md", "../../es/quality/estrategia-pruebas.md"),
    ("../../es/quality/CI_CD.md", "../../es/quality/ciclo-ci-cd.md"),
    ("../../es/quality/manual-calidad.md", "../../es/certificacion-iso/manual-calidad.md"),
    ("../../es/quality/plantillas-registros.md", "../../es/certificacion-iso/plantillas-registros.md"),
    ...
    ("../../pt-br/quality/rastreabilidade-iso.md", "../../pt-br/certificacion-iso/rastreabilidade-iso.md"),
    ("../../pt-br/quality/TESTING_STRATEGY.md", "../../pt-br/quality/estrategia-testes.md"),
    ("../../pt-br/quality/CI_CD.md", "../../pt-br/quality/ciclo-ci-cd.md"),
    ("../../pt-br/quality/manual-qualidade.md", "../../pt-br/certificacion-iso/manual-qualidade.md"),
    ("../../pt-br/quality/modelos-registros.md", "../../pt-br/certificacion-iso/modelos-registros.md"),
...
def locale_map(prefix):
    if prefix == "en":
        return [
            ...
            ("ACCESSIBILITY.md", "accessibility.md"), ("ISO_TRACEABILITY.md", "certificacion-iso/iso-traceability.md"),
            ("CI_CD.md", "ci-cd.md"), ("QUALITY_MANUAL.md", "certificacion-iso/quality-manual.md"),
            ("RECORDS_TEMPLATE.md", "certificacion-iso/records-template.md"), ("TESTING_STRATEGY.md", "testing-strategy.md"),
        ]
    if prefix == "es":
        return [
            ...
            ("ACCESSIBILITY.md", "accesibilidad.md"), ("ISO_TRACEABILITY.md", "certificacion-iso/trazabilidad-iso.md"),
            ("CI_CD.md", "ciclo-ci-cd.md"), ("QUALITY_MANUAL.md", "certificacion-iso/manual-calidad.md"),
            ("RECORDS_TEMPLATE.md", "certificacion-iso/plantillas-registros.md"), ("TESTING_STRATEGY.md", "estrategia-pruebas.md"),
        ]
    if prefix == "pt-br":
        return [
            ...
            ("ACCESSIBILITY.md", "acessibilidade.md"), ("ISO_TRACEABILITY.md", "certificacion-iso/rastreabilidade-iso.md"),
            ("CI_CD.md", "ciclo-ci-cd.md"), ("QUALITY_MANUAL.md", "certificacion-iso/manual-qualidade.md"),
            ("RECORDS_TEMPLATE.md", "certificacion-iso/modelos-registros.md"), ("TESTING_STRATEGY.md", "estrategia-testes.md"),
        ]
    return []
